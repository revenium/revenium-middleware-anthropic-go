...
>
> ```go
> import reveniumanthropic "github.com/revenium/revenium-go-sdk/anthropic"
> ```
>
> This repository is consolidated into the unified SDK; please use `revenium-go-sdk/anthropic` going forward.
